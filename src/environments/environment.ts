...
export const environment: Env = {
  ...
  enableFooter: base.enableFooter === "1",
  allowRegistration: base.allowRegistration === "1",
  allowPasswordReset: base.allowPasswordReset === "1",
  allowTermsOfUse: base.allowTermsOfUse === "1",
