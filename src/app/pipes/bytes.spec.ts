...
describe("Pipes", () => {
  ...
  it("BytesPipe", () => {
    ...
    expect(bytes_pipe.transform(0, 0)).toBe("0");
    expect(bytes_pipe.transform(10, 1)).toBe("10 bytes");
    expect(bytes_pipe.transform(10240, 1)).toBe("10 kB");
    expect(bytes_pipe.transform(10485760, 1)).toBe("10.0 MB");
