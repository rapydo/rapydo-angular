      ...
      template: ` 
                ...
                <div class="panel panel-default" ng-repeat="element in model[options.key]" ng-init="fields = copyFields(to.fields)">
                  <div class="panel-body">
                    ...
                    <div class="text-right">
                      <i class="fa fa-trash" style="color:red;" uib-tooltip="Remove this group of elements" ng-click="model[options.key].splice($index, 1)"></i>
                    </div>
                  </div>
                </div>
                <div class="text-right">
...
function tableSortConfig(tableSortConfigProvider) {
  ...
  filterString +=      "<div class='col-4 offset-8'>";
