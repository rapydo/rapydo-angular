...
if (Cypress.env("AUTH_SECOND_FACTOR_AUTHENTICATION")) {
  describe("Login with TOTP", () => {
    ...
    it("TOTP - change temporary password", () => {
      ...
      cy.get('input[placeholder="Your new password"]').type(pwd, { parseSpecialCharSequences: false });
      cy.get('input[placeholder="Confirm your new password"]').type(pwd, { parseSpecialCharSequences: false });
